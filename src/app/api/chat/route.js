...
export async function POST(req) {
    try {
        ...
        const systemInstruction = `
            You are EagleChat, a legal AI assistant powered by Gemini 2.0. You must provide legally accurate information while ensuring compliance with ethical guidelines. 
